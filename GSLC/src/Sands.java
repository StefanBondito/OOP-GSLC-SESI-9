...
public class Sands extends Artifacts implements Count{
	private double mainstat;
	private String stat;
	public Sands(String title, String type, int level, double mainstat, String stat, int rarity, double total) {
